...
extern "C" {
  pub fn strlen(s: *const ::std::os::raw::c_char) -> ::std::os::raw::c_int;
}
...
extern "C" {
  pub fn wasm_functype_vec_copy(
    out: *mut wasm_functype_vec_t,
    arg1: *const wasm_functype_vec_t,
  );
}
extern "C" {
...
fn bindgen_test_layout_wasm_val_t__bindgen_ty_1() {
  ...
  assert_eq!(
    unsafe {
      &(*(::std::ptr::null::<wasm_val_t__bindgen_ty_1>())).i32 as *const _
        as usize
    },
    0usize,
    concat!(
  ...
  assert_eq!(
    unsafe {
      &(*(::std::ptr::null::<wasm_val_t__bindgen_ty_1>())).i64 as *const _
        as usize
    },
    0usize,
    concat!(
  ...
  assert_eq!(
    unsafe {
      &(*(::std::ptr::null::<wasm_val_t__bindgen_ty_1>())).f32 as *const _
        as usize
    },
    0usize,
    concat!(
  ...
  assert_eq!(
    unsafe {
      &(*(::std::ptr::null::<wasm_val_t__bindgen_ty_1>())).f64 as *const _
        as usize
    },
    0usize,
    concat!(
...
extern "C" {
  pub fn wasm_val_vec_copy(
    out: *mut wasm_val_vec_t,
    arg1: *const wasm_val_vec_t,
  );
}
extern "C" {
